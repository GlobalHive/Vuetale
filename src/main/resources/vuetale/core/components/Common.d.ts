import { Anchor, ButtonSounds, ButtonStyle, CheckBoxStyle, ColorPickerDropdownBoxStyle, ColorPickerStyle, DropdownBoxStyle, InputFieldButtonStyle, InputFieldStyle, LabelStyle, Padding, PatchStyle, ScrollbarStyle, SliderStyle, TabNavigationStyle, TextButtonStyle, TextTooltipStyle, NATIVE } from 'vuetale/types/elements';
...
export declare const Vars: {
    ...
    DefaultButtonPadding: () => number;
    DefaultButtonDefaultBackground: () => PatchStyle;
    DefaultButtonHoveredBackground: () => PatchStyle;
    DefaultButtonPressedBackground: () => PatchStyle;
    DefaultButtonDisabledBackground: () => PatchStyle;
    DefaultSquareButtonDefaultBackground: () => PatchStyle;
    DefaultSquareButtonHoveredBackground: () => PatchStyle;
    DefaultSquareButtonPressedBackground: () => PatchStyle;
    DefaultSquareButtonDisabledBackground: () => PatchStyle;
    ...
    DefaultPopupMenuLayerStyle: () => {
        ...
        TitleBackground?: PatchStyle;
        RowHeight?: number;
        ItemLabelStyle?: LabelStyle;
        ItemPadding?: Anchor;
        ItemBackground?: PatchStyle;
        ItemIconSize?: number;
        HoveredItemBackground?: PatchStyle;
        PressedItemBackground?: PatchStyle;
        ItemSounds?: unknown;
    };
    ...
    HeaderTextButtonLabelStyle: () => LabelStyle;
